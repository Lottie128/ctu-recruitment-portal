...
const Apply = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      Object.keys(data).forEach(key => {
        if (key === 'passportPhoto' || key === 'certificates') {
          // Handle file inputs
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Application Form - REST OF FORM CONTINUES EXACTLY AS BEFORE... */}
      {/* I'll include just the key parts for brevity - the full form remains unchanged */}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            {/* ALL FORM STEPS REMAIN THE SAME - Only showing key file upload section */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-primary-500 transition-all">
                  <div className="text-center">
                    ...
                    />
                    {errors.passportPhoto && <span className="text-red-500 text-sm mt-1 block">Required</span>}
                  </div>
                </div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-primary-500 transition-all">
                  <div className="text-center">
                    ...
                    <input 
                      ...
                      className="w-full text-sm" 
                    />
                    {errors.certificates && <span className="text-red-500 text-sm mt-1 block">Required</span>}
                  </div>
                </div>
              </div>
            </div>
